...
class _DashboardScreenState extends State<DashboardScreen> {
      ...
      child: Column(children: [
        ...
        Padding(
          ...
          child: AnimatedSwitcher(
            ...
            child: isWide
                ? _wideBody(key: ValueKey('wide_$sec${selT?.id}'))
                : _body(key: ValueKey('narrow_$sec${selT?.id}')),
          ),
        ),
      ]),
    );
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                const Text('TOTAL CITY BUDGET',
                  style: TextStyle(fontSize: 10, color: Colors.white60,
                    fontFamily: 'Nunito', letterSpacing: 0.5)),
                const SizedBox(height: 2),
                Text(fmtCr(cityBudget),
            ...
            TweenAnimationBuilder<double>(
              ...
              builder: (context, val, _) =>
                  AnimatedBar(value: val, color: AppColors.orange, height: 8),
            ),
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  border: Border(bottom: BorderSide(
                    color: sec == t[0] ? AppColors.orange : Colors.transparent,
                    width: 3,
                  )),
                ),
                child: Text(t[1],
                  ...
                  style: TextStyle(
                    fontWeight: sec == t[0] ? FontWeight.w900 : FontWeight.w600,
                    fontSize: 13,
                    color: sec == t[0] ? AppColors.orange : AppColors.grey,
                    fontFamily: 'Nunito',
                  )),
              ),
            ),
  ...
  Widget _rightPanel() {
    return Column(children: [
      // Budget health by sector
      AppCard(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        const Text('Budget Health',
              ...
              children: [
                Text(s[2] as String,
                  style: TextStyle(fontSize: 18, fontWeight: FontWeight.w900,
                    color: s[1] as Color, fontFamily: 'Nunito'),
          ...
          Padding(padding: const EdgeInsets.only(bottom: 16), child: Column(children: [
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              Row(children: [
                ...
                const SizedBox(width: 8),
                Text('${s['v']}%',
                  style: TextStyle(color: s['c'] as Color, fontWeight: FontWeight.w900,
                    fontFamily: 'Nunito')),
              ]),
            ]),
            ...
            TweenAnimationBuilder<double>(
              ...
              builder: (context, val, _) =>
                  AnimatedBar(value: val, color: s['c'] as Color, height: 7),
            ),
          ])),
      ])),
    ...
    return Column(key: key, crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w700,
                color: AppColors.dark, fontFamily: 'Nunito'),
              items: const [
      ...
      SizedBox(height: 36, child: ListView(
        ...
        children: filters.map((f) => Padding(
          ...
          child: AppChip(
            label: f, color: AppColors.orange,
            active: tenderFilter == f,
            onTap: () => setState(() => tenderFilter = f),
            small: true,
          ),
        )).toList(),
      )),
          ...
          child: AppCard(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(children: [
                ...
                Text('${t.contractor} · GPS Verified',
                  style: const TextStyle(fontSize: 12, color: AppColors.greyDark,
                    fontFamily: 'Nunito')),
              ]),
              const SizedBox(height: 14),
              AnimatedBar(
                value: t.pct.toDouble(),
                color: t.pct == 100 ? AppColors.green : (sc[t.status] ?? AppColors.orange),
                height: 8,
              ),
              const SizedBox(height: 8),
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Row(children: [
        ...
        Container(
          ...
          child: IconButton(
            icon: const Icon(Icons.share_outlined, size: 18, color: AppColors.dark),
            onPressed: () {},
          ),
        ),
      ]),
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            Text('${t.pct}%',
              style: TextStyle(fontWeight: FontWeight.w900, fontSize: 16,
                color: t.pct == 100 ? AppColors.green : c, fontFamily: 'Nunito')),
          ]),
          const SizedBox(height: 8),
          TweenAnimationBuilder<double>(
            ...
            curve: Curves.easeOutCubic,
            builder: (context, val, _) =>
                AnimatedBar(value: val, color: t.pct == 100 ? AppColors.green : c, height: 12),
          ),
          const SizedBox(height: 18),
          GridView.count(
            crossAxisCount: 2, shrinkWrap: true, physics: const NeverScrollableScrollPhysics(),
                ...
                children: [
                  ...
                  Text(item[1],
                    style: TextStyle(fontWeight: FontWeight.w900, fontSize: 14,
                      color: item[1] == 'Verified ✓' ? AppColors.green : AppColors.dark,
                      fontFamily: 'Nunito')),
                ],
              ),
            )).toList(),
      ...
      AppCard(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        const Text('Work Update Log',
          style: TextStyle(fontWeight: FontWeight.w900, fontSize: 16, fontFamily: 'Nunito')),
        const SizedBox(height: 16),
  ...
  Widget _stats({Key? key}) {
    return Column(key: key, children: [
      ...
      AppCard(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        const Text('Expenditure by Sector',
          style: TextStyle(fontWeight: FontWeight.w900, fontSize: 16, fontFamily: 'Nunito')),
        const SizedBox(height: 4),
        const Text('Allocation breakdown for FY 2025-26',
        ...
        for (final s in sectors)
          Padding(padding: const EdgeInsets.only(bottom: 18), child: Column(children: [
            ...
            TweenAnimationBuilder<double>(
              ...
              curve: Curves.easeOutQuart,
              builder: (context, val, _) =>
                  AnimatedBar(value: val, color: s['c'] as Color, height: 10),
            ),
          ])),
      ])),
        ...
        for (final row in [
          ...
          Padding(padding: const EdgeInsets.only(bottom: 14), child: Row(children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: (row[1] as Color).withOpacity(0.1),
                borderRadius: BorderRadius.circular(10),
              ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(label,
            style: const TextStyle(fontSize: 9.5, color: AppColors.greyDark,
              fontWeight: FontWeight.w700, fontFamily: 'Nunito')),
        ],
      ),
    );
  ...
  Widget _activityFeed({Key? key}) {
    return Column(key: key, crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      const SizedBox(height: 4),
      const Text('Latest updates across all projects',
        style: TextStyle(fontSize: 12, color: AppColors.grey, fontFamily: 'Nunito')),
      const SizedBox(height: 20),
